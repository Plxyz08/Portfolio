...
export default function FreelanceProjects() {
  ...
  const freelanceProjects = [
    ...
    },
    {
      ...
      description:
        "Desarrollo completo a medida de una plataforma web de directorio empresarial con contenido para adultos (+18), sistema de membresías, módulo de chat en caliente y chat entre usuarios. Todo el desarrollo fue realizado siguiendo estrictamente las especificaciones y requerimientos solicitados por el cliente.",
      details: [
        "Desarrollo 100% personalizado según las especificaciones exactas del cliente, adaptando cada funcionalidad a sus necesidades específicas y requerimientos de negocio.",
        ...
        "Implementación de un sistema de chat en tiempo real que permite tanto conversaciones entre usuarios como un módulo de 'chat en caliente' para interacciones específicas del negocio.",
    ...
    {
      id: 4,
      title: "Desarrollo Front-end - CS Tracer",
      period: "Enero 2025 - Febrero 2025",
      client: "CardSoftware",
      location: "Remoto",
      image: "/Freelance/CardSoftware.png",
      description:
        "Desarrollo front-end para el proyecto CS Tracer, una plataforma de seguimiento y gestión de la industria textil. Trabajé durante un mes como desarrollador front-end utilizando Next.js y React para implementar interfaces de usuario modernas y funcionales según los requerimientos del cliente.",
      details: [
        "Desarrollo de componentes de interfaz de usuario utilizando React y Next.js para la plataforma CS Tracer.",
        "Implementación de páginas responsivas y optimizadas para diferentes dispositivos y navegadores.",
        "Integración con APIs RESTful para la obtención y manipulación de datos en tiempo real.",
        "Desarrollo de formularios complejos con validación avanzada para la gestión de información de tarjetas.",
        "Implementación de dashboards interactivos con gráficos y visualizaciones de datos para el seguimiento de métricas.",
        "Colaboración estrecha con el equipo de diseño para asegurar la fidelidad visual y la experiencia de usuario.",
        "Participación en reuniones diarias de seguimiento y planificación de sprints según metodología ágil.",
        "Realización de pruebas unitarias y de integración para asegurar la calidad del código.",
        "Documentación detallada de componentes y funcionalidades desarrolladas para facilitar el mantenimiento futuro.",
      ],
      technologies: [
        "Next.js",
        "React",
